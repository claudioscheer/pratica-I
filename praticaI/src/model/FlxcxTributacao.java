 ...
 */
@Entity
@Table(name = "flxcx_tributacao", schema = "public"
)
@SequenceGenerator(name = "seq_TribCodigo", sequenceName = "seq_TribCodigo",
        allocationSize = 1)
public class FlxcxTributacao implements java.io.Serializable {
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_TribCodigo")
