...
public class RelatorioAtivosImobilizado {

    DefaultTableModel tableModel;

    public RelatorioAtivosImobilizado() {
        JasperPrint jasperPrint = null;
        TableModelData();
        try {
            JasperCompileManager.compileReportToFile("\\relatorios\\patrimonio\\RelatorioAtivosImobilizado.jrxml");
            jasperPrint = JasperFillManager.fillReport("RelatorioAtivosImobilizado.jasper", new HashMap(),
    ...
    public static void main(String[] args) {
        new RelatorioAtivosImobilizado();
    }
